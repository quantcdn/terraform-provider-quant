...
func Provider() tfbridge.ProviderInfo {
	info := tfbridge.ProviderInfo{
		...
		Resources: map[string]*tfbridge.ResourceInfo{
			...
			// Resources with string IDs.
			"quant_rule_proxy":           {Tok: "quant:index:RuleProxy"},
			"quant_rule_redirect":        {Tok: "quant:index:RuleRedirect"},
			"quant_rule_custom_response": {Tok: "quant:index:RuleCustomResponse"},
			"quant_rule_content_filter":  {Tok: "quant:index:RuleContentFilter"},
			"quant_rule_function":        {Tok: "quant:index:RuleFunction"},
			"quant_rule_auth":            {Tok: "quant:index:RuleAuth"},
			"quant_rule_bot_challenge":   {Tok: "quant:index:RuleBotChallenge"},
			"quant_rule_headers":         {Tok: "quant:index:RuleHeaders"},
			"quant_rule_serve_static":    {Tok: "quant:index:RuleServeStatic"},
